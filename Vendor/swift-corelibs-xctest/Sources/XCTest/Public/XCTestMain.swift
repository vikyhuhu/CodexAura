...
// CodexAura vendors XCTest only for macOS Command Line Tools builds, where the
// Apple Foundation framework is available but the toolchain-only
// SwiftFoundation module is not shipped.
